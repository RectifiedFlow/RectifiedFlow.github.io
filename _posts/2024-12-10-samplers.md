...
$$ d \tilde{Z}_t = \underbrace{v_t(\tilde{Z}\_t)dt}_{\text{Rectified Flow term}} + \underbrace{ \sigma*t^2 \nabla \log \rho_t(\tilde{Z}\_t) dt + \sqrt{2} \sigma_t d W_t}*{\text{Langevin dynamics term}},$$
