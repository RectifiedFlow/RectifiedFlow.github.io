...
<div class="l-body-outset">
  <figure id="figure-3">
    ...
    <figcaption>
      ...
      As we reduce the number of Euler steps, the final outputs of the straight and spherical rectified flows begin to diverge. With fewer steps, the discretization errors become more pronounced, causing greater differences at \(Z_1\).
    </figcaption>
  </figure>
</div>
...
<div class="l-body-outset">
  <figure id="figure-5">
    ...
    <figcaption>
      ...
      Here, we reparameterize the straight RF model \(v_t(x;\theta)\) into \(v'_t(x;\theta)\) and train it under spherical interpolation with matched time weighting and parameterization. Under these conditions, the resulting trajectories align almost perfectly.
    </figcaption>
  </figure>
</div>
